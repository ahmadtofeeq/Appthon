...
public final class CaptureActivity extends Activity implements
	...
	void onShutterButtonPressContinuous() {
		...
		if (lastResult != null) {
			...
			mIntent.putExtra("data", lastResult);
	...
	boolean handleOcrDecode(OcrResult ocrResult) {
		...
		if (ocrResult.getText() == null || ocrResult.getText().equals("")) {
			...
			if (lastBitmap != null) {
				WriteBitmap m = new WriteBitmap(fileName, lastBitmap);
				m.start();
			}
			Intent mIntent = new Intent();
			mIntent.putExtra("path", fileName);
			mIntent.putExtra("data", lastResult.getText());
		...
		// findViewById(R.id.translation_language_label_text_view);
		// TextView translationLanguageTextView = (TextView)
		// findViewById(R.id.translation_language_text_view);
		// TextView translationTextView = (TextView)
		...
		// translationLanguageTextView.setTypeface(Typeface.defaultFromStyle(Typeface.NORMAL),
		// Typeface.NORMAL);
	...
	class WriteBitmap extends Thread {
		String sfile;
		Bitmap bitmap;

		public WriteBitmap(String file, Bitmap bitmap) {
			this.sfile = file;
			this.bitmap = bitmap;
		}
